<div class="hero-wrap hero-bread" style="background-image: url('<?php echo base_url(); ?>assets/landingpage/images/shopping.jpg');">
    ...
    <section class="ftco-section">
      ...
      <div class="container">
        <div class="row no-gutters ftco-services">
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              <div style="background-color: grey;" class="icon bg-color-2 d-flex justify-content-center align-items-center mb-2">
    ...
    <div class="col-xl-10">
      ...
      <a href="<?php echo base_url(); ?>Store/status_pembayaran/<?php echo $transaksi->id_transaksi; ?>" style="margin-bottom: 50px;" class="btn btn-primary">Verifikasi Pembayaran</a> <!-- .col-md-8 -->
    </div>
  </center>
